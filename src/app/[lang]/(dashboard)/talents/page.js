  ...
  return (
    <div className="fade-in" style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <h1 style={{ fontSize: "20px", fontWeight: "700", color: "var(--foreground)", letterSpacing: "-0.02em" }}>{t("dashboard.talents.title")}</h1>
          <p style={{ color: "var(--muted-foreground)", fontSize: "13px", marginTop: "2px" }}>
            {t("dashboard.talents.subtitle")}
          </p>
        </div>
      ...
      <div style={{ position: "relative", maxWidth: "320px" }}>
        ...
        <input
          ...
          placeholder={t("dashboard.talents.search")}
          value={search}
      ...
      {filtered.length === 0 ? (
        <div className="card" style={{ textAlign: "center", padding: "48px 32px" }}>
          ...
          <p style={{ fontSize: "15px", fontWeight: "600", color: "var(--foreground)", marginBottom: "6px" }}>
            {talents.length === 0 ? t("dashboard.talents.noneSaved") : t("dashboard.talents.noResults")}
          </p>
          <p style={{ fontSize: "13px", color: "var(--muted-foreground)" }}>
            {talents.length === 0
              ? t("dashboard.talents.noneSavedHelp")
              : t("dashboard.talents.noResultsHelp")}
          </p>
        </div>
      ) : (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "16px", flexShrink: 0 }}>
                  {talent.score_cv != null && (
                    <div title={t("dashboard.talents.cvScore")} style={{
                  ...
                  {talent.score_tests != null && (
                    <div title={t("dashboard.talents.testsScore")} style={{
                      display: "flex", alignItems: "center", gap: "4px",
                      fontSize: "12px", fontWeight: "600",
                  ...
                  {talent.score_interview != null && (
                    <div title={t("dashboard.talents.interviewScore")} style={{
                      display: "flex", alignItems: "center", gap: "4px",
                      fontSize: "12px", fontWeight: "600",
                  ...
                  {talent.pool_added_at && (
                    <span style={{ fontSize: "11px", color: "var(--muted-foreground)" }}>
                      {formatDateShort(talent.pool_added_at, locale)}
                    </span>
                  )}
                  <button
                    onClick={(e) => handleRemoveFromPool(e, talent.id)}
                    title={t("dashboard.talents.removeFromPool")}
                    style={{
