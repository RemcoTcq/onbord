...
const candidate = {
  ...
  sandbox: {
    ...
    code: {
      ...
      attemptsLeft: "{count} runs left",
      hiddenTests: "{count} hidden tests",
      hiddenTest: "Hidden test {n}",
      noTests: "No automated tests on this step: your code will be reviewed as it is.",
      ...
      errors: {
        ...
        no_tests: "No tests are configured on this step.",
        limit_reached: "You have reached the run limit for this step. Your code is saved and will be reviewed.",
        generic: "Execution failed. Please try again.",
      },
    },
